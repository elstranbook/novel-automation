...
export async function POST(request: Request) {
  try {
    ...
    const prompt = `
I have a description of a Young Adult novel. Convert it into structured story details.
...
2. genre: The specific genre or genres
3. story_theme: The central theme or message
4. central_concept: The core idea or high-concept premise
5. estimated_word_count: Estimated word count (default 50000-80000 for YA)
6. target_age_range: The intended audience age range (e.g., 12-15, 13-18)
...
13. narrative_style: First person, third person limited, omniscient, etc.
...
`;
    ...
    const systemMessage =
      "You are a professional young adult novelist and editor skilled at analyzing book descriptions and extracting structured details. Your task is to convert a plain text description into structured story details for a YA novel. Be specific and creative with your inferences while staying true to the provided description.";
